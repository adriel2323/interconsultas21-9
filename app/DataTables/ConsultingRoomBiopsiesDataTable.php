...
class ConsultingRoomBiopsiesDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable->addColumn('action', 'consulting_room_biopsies.datatables_actions')
     ...
     */
    public function query(ConsultingRoomBiopsies $model)
    {
        $biopsies = ConsultingRoomBiopsies::with('os','biopsy_type','doctor','patologist');
    ...
    {
        return 'Biopsias_de_Consultorios_' . time();
    }
}